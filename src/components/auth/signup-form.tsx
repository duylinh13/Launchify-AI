      ...
      <form action={formAction}>
        <CardContent className="space-y-6 px-8">
          ...
          <div className="space-y-3">
            ...
            <Input id="password" name="password" type="password" required minLength={6} className="h-12 rounded-xl bg-background/50 focus-visible:ring-primary/50 text-base px-4" />
          </div>
          {state?.error && (
        ...
        <CardFooter className="flex justify-center pb-10 pt-4">
          <p className="text-sm text-muted-foreground">
            ...
            <Link href="/login" className="font-semibold text-primary hover:underline hover:text-purple-500 transition-colors">
              Log in
            </Link>
          </p>
        </CardFooter>
